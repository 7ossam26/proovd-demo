  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-brand-bg/90 backdrop-blur-md">
        {/* Floating Background Particles (Simplified from HTML) */}
        ...
        <div className="flex flex-col items-center max-w-lg w-full relative">
          ...
          <motion.div
            ...
            <button
              ...
              className="bg-brand-primary hover:bg-brand-primary-dark text-brand-surface-dark font-bold py-4 px-10 rounded-full shadow-lg hover:shadow-brand-primary/50 transition-all duration-300 transform hover:-translate-y-1 text-lg">
              View Matches
            </button>
          </motion.div>
        </div>
